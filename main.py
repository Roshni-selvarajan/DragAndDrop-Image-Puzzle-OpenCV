...
#loading and positioning the img

initial_positions = list(original_positions.values())
random.shuffle(initial_positions) #shuffleing randomly at the biginning
...
#main loop
while True:
    success, img = cap.read() #capture vd from the webcam
    img = cv2.flip(img, 1) #flip the video
